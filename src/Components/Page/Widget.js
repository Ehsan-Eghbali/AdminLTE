      ...
      <div className="content-wrapper" style={{marginLeft: 0}}>
        ...
        <section className="content">
          <div className="container-fluid">
            ...
            <h5 className="mt-4 mb-2">Info Box With </h5>
            <div className="row">
              <div className="col-md-3 col-sm-6 col-12">
            ...
            <div className="row">
              ...
              <div className="col-md-4">
                <div className="card card-widget widget-user">
                  ...
                  <div className="widget-user-image">
                    <img className="img-circle elevation-2" src="./assets/dist/img/user1-128x128.jpg" alt="User Avatar" />
                  </div>
                  <div className="card-footer">
                    <div className="row">
                ...
                <div className="row">
                  ...
                  <div className="col-md-12 col-lg-6 col-xl-4">
                    <div className="card mb-2">
                      <img className="card-img-top" src="./assets/dist/img/photo2.png" alt="Dist Photo 2" />
